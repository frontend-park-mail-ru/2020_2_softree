...
export default class ProfileSettings extends Component {
    ...
    render() {
        ...
        <div>
            <div class="profile-settings">
                <div class="avatar-container">
                    <img class="avatar" src=${this.state.avatar || '/src/images/avatar.svg'} alt="avatar"/>
        ...
        this.listen('.btn.password', 'click', () => this.setState({changePasswordIsOpen: !this.state.changePasswordIsOpen}))
        this.listen('.btn.overal', 'click', () => this.setState({overalInfoIsOpen: !this.state.overalInfoIsOpen}))
